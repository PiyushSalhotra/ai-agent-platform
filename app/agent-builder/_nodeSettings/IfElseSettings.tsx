...
function IfElseSettings({selectedNode,updateFormData}:any) {
  ...
  return (
    <div>
      I<h2 className='font-bold'>If / Else</h2>
      <p className='text-gray-500 mt-2'>Create conditions to branch your workflow</p>
      <div className='mt-3'>
        <Label>If</Label>
        <Input placeholder='Enter condition e.g output==`any condition`' className='mt-2' onChange={(e)=>setFormData({ifCondition:e.target.value})}
